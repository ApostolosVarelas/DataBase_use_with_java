...
public static void main(String[] args) throws SQLException {
	...
	System.out.println("MySQL Connect DataBase_DT");
	conn = null;
	String url = "jdbc:mysql://localhost:3306/";
	String dbName = "database_dt";
...
//show menu
		...
		System.out.println("7.Retrieval Employee List\n");
...
//save the integer
		...
		//Insert case
				...
				//Storage
				        try{
				            ...
				            System.out.println("Please,insert the new storage code:");

				        	String code=sc1111.nextLine();
				...
				case 2:{	
				 //Storage Bin
				        try{
				            ...
				            System.out.println("Please,instert the new storage bin code:");

				        	 int code=sc22.nextInt();
				        	 Scanner sc3= new Scanner (System.in);

				             System.out.println("Please,insert the new capacity:");
				    ...
				    //Data Base
						try{
							  Statement st = MysqlConnect.conn.createStatement();
							  	...
							  	System.out.println("Please,insert the new data base code:");

							  	String code=sc1.nextLine();
							  	
					        	Scanner sc3= new Scanner (System.in);

					            System.out.println("Please,inster the new portion:");
					          	
					            int portion=sc3.nextInt();
					          
					            Scanner sc0= new Scanner (System.in);

						        System.out.println("Please,insert the manager Name:");
					            ...
					            Scanner sc4= new Scanner (System.in);
						         ...
						         System.out.println("Please,insert the order quantity:");
						          	
						          int or_quantity=sc5.nextInt();
						            
						          Scanner sc6= new Scanner (System.in);

							       System.out.println("Please,insert the entry date:");
				...
				int val = st.executeUpdate("INSERT INTO data_base VALUES('"+code+"','"+portion+"','"+m_name+"','"+order_date+"','"+or_quantity+"','"+en_date+"','"+quantity+"')");
				  ...
				  //Peceipt Batch
				        try{
				             ...
				             System.out.println("Please,insert the peceipt Batch Code :");
					...
					//Manager
				        try{
						      ...
						      System.out.println("Please,insert the enter the name:");
						      ...
						      System.out.println("Please,insert the check date:");
						          	
						      String ch_date=sc7.nextLine();
				              
						      Scanner sc8= new Scanner (System.in);

						      System.out.println("Please,insert the data base code:");
						          	
						      String data_code=sc8.nextLine();
						      
						      Scanner sc9= new Scanner (System.in);

						      System.out.println("Please,insert the peceipt code:");
					...
					//Assembled
				        try{
				            ...
				            System.out.println("Please,insert the new assembled code:");
				            
				            int as_code=sc42.nextInt();
				            
				            Scanner sc3= new Scanner (System.in);

				            System.out.println("Please,insert the find a peceipt code:");
				            ...
				            System.out.println("Please,insert the find a data base code:");
					...
					//Piece
				         try{
					         ...
					         System.out.println("Please,insert the new piece code:");
				...
				break;
					...
					//Accessories
			             ...
			             Scanner sc1= new Scanner (System.in);
				         System.out.println("Please,insert the new accessories code:");
				         String code=sc1.nextLine();
				         
				         Scanner sc12= new Scanner (System.in);
				         System.out.println("Please,insert the new storage bin code:");
				         ...
				         System.out.println("Please,insert the new peceipt batch code:");
					...
					//Employee
				           try{
				                 ...
				                 System.out.println("Please,insert the new employe code:");

				                 String code=sc1.nextLine();
				                 
				                 Scanner sc62= new Scanner (System.in);

				                 System.out.println("Please,insert the new employe name:");

				                 String name=sc62.nextLine();
				                 
				                 Scanner sc3= new Scanner (System.in);

				                 System.out.println("Please,insert the new employe surname:");

				                 String surname=sc3.nextLine();
				                 
				                 Scanner sc4= new Scanner (System.in);

				                 System.out.println("Please,insert the Father's name:");

				                 String f_name=sc4.nextLine();
				                 
				                 Scanner sc90= new Scanner (System.in);

				                 System.out.println("Please,insert the manager's name:");
					...
					//Address
			               ...
			               System.out.println("Please,insert the address number:");
			               ...
			               System.out.println("Please,insert the employee code:");
			   		...
			   		//phoneNumbers
			            ...
			            try{
			            	...
			            	Statement st = MysqlConnect.conn.createStatement();
			                  ...
			                  System.out.println("Please,insert the new phone code:");
			                  ...
			                  System.out.println("Please,insert the new employee  code:");
		...
		//show update menu
				...
				System.out.println("10.Update the address\n");
				...
				switch(choice3) {					
					...
					//Storage Bin
				        try{
				            ...
				            Scanner sc1101= new Scanner (System.in);
				            System.out.println("Update storage bin code");
				        	int code2=sc1101.nextInt();
					...
					//Data Base
						try{
							  Statement st = MysqlConnect.conn.createStatement();
					            ...
					            System.out.println("Please,insert the new portion");
					...
					//Address
			               ...
			               System.out.println("Please,insert the new city name:");
					...
					//phoneNumbers
			            ...
			            try{
			            	...
			            	Statement st = MysqlConnect.conn.createStatement();
			                  ...
			                  System.out.println("Please,insert the new phone:");
...
//Retrieve list of repositories
			...
			case 4: {
//retrieve a list of components per receiving batch and per storage bin
		           try
		           {
		               Statement st = MysqlConnect.conn.createStatement();
		               ...
		               while (res.next()) {
		            	   ...
		            	   System.out.print("Storage Bin code: " + res.getInt("storage_bin_code") + "\t");
		                   System.out.print("Peceipt Batch: " + res.getInt("peceipt_batch_code")+ "\t");  
		                   System.out.print("Accessories code: " +res.getString("code")+ "\t");
...
//find the available capacity and left capacity
			...
			case 6:{
//Update of available and remaining capacity	
				 try
		           {
		               Statement st = MysqlConnect.conn.createStatement();
		               String query = "Select * from storage_bin";
...
//Retrieval Employee List
	   	          try
	   	          {
	   	              ...
	   	              {
	   	                //Display values
	   	                  System.out.print("Employee code: " + res.getString("code") + "\t");
	   	                  System.out.print("Employee's name: " + res.getString("name") + "\t");
	   	                  System.out.print("Employee's surname: " + res.getString("surname") + "\t");
	   	              ...
	   	              while(res2.next())
	   	              {
	   	                  System.out.print("City Name: " + res2.getString("city_name") + "\t");
	   	                  System.out.print("Address Name: " + res2.getString("address_name") + "\t");
	   	                  System.out.print("Address Number: " + res2.getInt("address_number") + "\t");
	   	                  System.out.println("Postal Code: " + res2.getString("postal_code") + "\t");
	   	              }
	   	              res2.close();
	   	          }catch(SQLException s){
	   	              System.out.println("SQL statement is not execute !");
	   	        }
...
//Retrieval Name Manager List
	   	          try
	   	          {
	   	              ...
	   	              {
	   	                //Display values
	   	                  System.out.println("Manager name: " + res.getString("name"));
	   	            }
	   	              res.close();
	   	          }catch(SQLException s){
	   	              System.out.println("SQL statement is not execute !");
...
//Recovery of Component List
	   	          try
	   	          {
	   	              ...
	   	              while(res.next())
	   	              {
	   	                //Display values
	   	                  System.out.print(" Accessories Code: " + res.getString("code")+ "\t");
	   	                  System.out.print("Storage Bin Code: " + res.getString("storage_bin_code")+ "\t");
...
//Retrieve List of new orders
	   	          try
	   	          {
	   	              ...
	   	              {
	   	                //Display values
	   	                  System.out.print("Manager name: " + res.getString("manager"));
